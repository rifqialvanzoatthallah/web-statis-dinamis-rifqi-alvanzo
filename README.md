...
Selain itu, project ini juga dilengkapi dengan:

* Tampilan UI yang clean dan modern
* Navigasi yang mudah dipahami
* Section sosial media terintegrasi
...
1. Clone repository ini:
   ...
   ```bash
   git clone https://github.com/rifqialvanzoatthallah/web-statis-dinamis-rifqi-alvanzo.git
   ```

2. Masuk ke folder project:

   ```bash
   cd web-statis-dinamis-rifqi-alvanzo
   ```
...
* Menggunakan framework (React / Vue)
